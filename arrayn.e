note
	description: "Representation of a Multi-dimensional Array."
	design: "[
		This class is a freebie to you! It is not available in any
		of the libraries, but you can feel free to copy it and use
		it in your projects as you like or want.
		]"
...
feature -- Access
	...
	item_at alias "[]" (a_vector: TUPLE): detachable G
		do
			Result := at (a_vector)
		end
...
feature -- Basic Operations
	...
	do_while (a_action: PROCEDURE [TUPLE [G]]; a_test: FUNCTION [TUPLE [G], BOOLEAN])
